...
This is an early build. I'm actively shipping improvements (Markets, Contract, Interface, flow, etc) and would love the opportunity to take LOFIBets further with grant support from the Sui ecosystem as I see this getting really big for LOFI and the SUI eco at large.
